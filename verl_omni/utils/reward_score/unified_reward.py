...
async def compute_score_unified_reward(
    ...
    caption = extra_info.get("prompt") or extra_info.get("caption") or ground_truth or ""
    ...
    return {
        "score": float(score),
        "unified_reward_raw_score": float(raw_score),
        "unified_reward_scores": all_axis_scores[-1],
        "unified_reward_all_scores": all_axis_scores,
        "unified_reward_response": unified_reward_response,
    }
