# Qwen-Image offline DPO training on pre-ranked image pairs
set -x
...
offline_train_path=${OFFLINE_DPO_TRAIN_PATH:-$SCRIPT_DIR/../../datasets/offline_dpo_qwen_image/train.parquet}
offline_test_path=${OFFLINE_DPO_TEST_PATH:-$SCRIPT_DIR/../../datasets/offline_dpo_qwen_image/test.parquet}
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    actor_rollout_ref.model.architecture=QwenImagePipeline \
    ...
    trainer.experiment_name=qwen_image_offline_dpo_lora \
