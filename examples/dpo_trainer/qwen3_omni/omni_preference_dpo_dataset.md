...
Script:
[`examples/dpo_trainer/data_process/omni_preference_dpo_multisource.py`](../data_process/omni_preference_dpo_multisource.py)
...
See
[`examples/dpo_trainer/qwen3_omni/run_qwen3_omni_thinker_only_offline_mllm_dpo_lora.sh`](run_qwen3_omni_thinker_only_offline_mllm_dpo_lora.sh)
and
